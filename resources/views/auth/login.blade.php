            ...
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" type="email" class="form-input  rounded-full w-full bg-gray-100 dark:bg-gray-700 dark:text-gray-300 @error('email') border-red-500 @enderror" name="email" value="{{ old('email') }}" required autocomplete="off" autofocus>
                        @error('email')
                    ...
                    <div class="mb-4">
                        ...
                        <input id="password" type="password" class="form-input rounded-full w-full bg-gray-100 dark:bg-gray-700 dark:text-gray-300 @error('password') border-red-500 @enderror" name="password" required autocomplete="off">
                        @error('password')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
